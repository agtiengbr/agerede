...
abstract class AbstractService
{
    ...
    protected function sendRequest($body = null, $method = 'GET')
    {
        ...
        $obj->endpoint = $this->store->getEnvironment()->getEndpoint($this->getService());
        $obj->headers = serialize($headers);
        $obj->method = $method;
        $obj->body = serialize(preg_replace('/"(cardnumber|securitycode)":"[^"]+"/i', '"\1":"***"', $body));
        $obj->http_code = (int) $statusCode;
