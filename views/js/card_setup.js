document.addEventListener('DOMContentLoaded', function () {
    if (typeof Card === 'undefined' || !document.querySelector('#agerede_credit_card')) {
        return;
    }

    var card = new Card({
        form: '#agerede_credit_card',
        container: '#agerede_credit_card .card-wrapper',
    ...
    // Bandeiras de cartao com seus padroes (cor da miniatura muda conforme a bandeira)
    const cardTypes = [
    ...
    function applyBrandClass() {
        var cardNumber = $('#agerede_credit_card input[name=agerede_cardnumber]').val();
        var cardElement = $('.jp-card');
    ...
    $('#agerede_credit_card input[name=agerede_cardnumber]').on('input change paste', function (e) {
        if (e.type === 'paste') {
