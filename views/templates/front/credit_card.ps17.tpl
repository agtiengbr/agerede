    ...
    <div class="box cheque-box">
        <div class="row">
            <div id="cardnumber" class="col-xs-12 col-md-6 col-lg-7">
                ...
                <input type="text" name="agerede_cardnumber" id="agerede_cardnumber" class="col-xs-12" tabindex="1" autocomplete="off" placeholder="Número do Cartão" />
                <div class="agerede_cardbanner"></div>
            </div>
            <div class="col-xs-12 col-md-4 col-lg-3">
                <label class="col-xs-12 sr-only">Cod. Segurança</label>
                <input type="text" name="agerede_cvv" id="agerede_cvv" class="col-xs-12" tabindex="1" autocomplete="off" maxlength="4" placeholder="CVV" />
            </div>
        </div>
        <div class="row">
            <div id="cardholder" class="col-xs-12 col-md-12 col-lg-12">
                <label class="col-xs-12 sr-only">Nome do Proprietário</label>
                <input type="text" name="agerede_name" id="agerede_name" class="col-xs-12" tabindex="1" autocomplete="off" maxlength="48" placeholder="Nome conforme exibido no cartão" />
            </div>
        </div>
        <div class="row">
            <div id="installment" class="col-xs-12 col-md-6 col-lg-7">
                <label class="col-xs-12 sr-only">Parcelamento</label>
                <select name="agerede_installment" id="agerede_installment" class="col-xs-12 is-not-selected" tabindex="1" autocomplete="off" maxlength="24">
            ...
            <div id="month" class="col-xs-12 col-md-4 col-lg-5">
                <label class="col-xs-12 sr-only">Validade</label>
                <select name="agerede_month" id="agerede_month" class="col-xs-7 is-not-selected" tabindex="1" autocomplete="off" maxlength="24">
                ...
                <select name="agerede_year" id="agerede_year" class="col-xs-5 is-not-selected" tabindex="1" autocomplete="off" maxlength="24">
